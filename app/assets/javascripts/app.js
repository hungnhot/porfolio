  ...
  var ContactFormApp = {
    ...
    contactFormSubmit: function(obj) {
      if (this.validate() == "") {
        ...
        this.$contactForm.delay(500).slideUp(1000);
        $('section#contact p.sub-title').delay(500).slideUp(1000);
        $('section#contact h3.title').delay(500).slideUp(1000);
